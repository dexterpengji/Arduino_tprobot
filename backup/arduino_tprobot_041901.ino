...
ros::Subscriber<std_msgs::String> sub_actuator("arduino_sendData", move_actuator);
...
void setup()   {  
  ...
  display.println("mi:" + String(millis()));
  display.display();
}
...
void loop() {
  ...
  display.println("= ready =");
  display.println("mi:" + String(millis()));
  display.println("data:" + String(cmd_test));
  display.display();
  */
